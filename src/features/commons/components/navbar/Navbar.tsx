...
import DropdownMenu from "@/features/commons/components/Dropdown";

const categories = ["Category 1", "Category 2", "Category 3"];

export default function Navbar() {
  return (
    <header className="flex justify-between w-full  items-center text-black p-4 px-10 font-primary fixed top-0 right-0 z-50 bg-white">
      <svg
        width="55"
        height="21"
        viewBox="0 0 55 21"
      ...
      <nav className="flex justify-center items-center align-middle text-center gap-4">
        <Link href="/" className="px-4 py-2 rounded-3xl fill-current hover:bg-black hover:text-white flex gap-2 items-center text-black">Home</Link>
        <DropdownMenu
          buttonContent="Categories"
          items={categories}
        />
        <Link href="/" className="px-4 py-2 rounded-3xl fill-current hover:bg-black hover:text-white flex gap-2 items-center text-black">Contact Us</Link>
        <Link href="/" className="px-4 py-2 rounded-3xl fill-current hover:bg-black hover:text-white flex gap-2 items-center text-black">Blog</Link>
      </nav>
      ...
      <div className="flex items-center gap-2"> 
          ...
          />
          <Link href="/" className="relative px-4 py-2 rounded-3xl fill-current hover:bg-black hover:text-white flex gap-2 items-center text-black">
            <svg
              width="18"
              height="18"
              viewBox="0 0 19 20"
            ...
            <span className="absolute top-[-5] right-[-5] bg-purple-300 text-black rounded-full w-5 h-5 text-sm flex justify-center items-center">2</span>
          </Link>
        </div>
    </header>
  );
