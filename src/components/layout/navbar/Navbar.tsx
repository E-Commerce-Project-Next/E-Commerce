...
export default function Navbar() {
  return (
    <header className="flex justify-between w-full  items-center text-black p-4 px-10 font-primary">
      <svg
        width="55"
        height="21"
        viewBox="0 0 55 21"
      ...
      <div className="flex items-center gap-2"> 
          ...
          <Link href="/" className="relative px-4 py-2 rounded-3xl fill-current hover:bg-black hover:text-white flex gap-2 items-center text-black">
            ...
            <span className="absolute top-[-1] right-[-1] bg-red-500 rounded-full w-5 h-5 text-sm flex justify-center items-center">2</span>
          </Link>
        </div>
    </header>
  );
